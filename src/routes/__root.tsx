...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Stock Bersek — AI Trading Desk" },
      {
        name: "description",
        content: "Live tokenized stock data with an AI briefing. AI analyzes, you decide.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: "/stock-bersek-logo.jpg", type: "image/jpeg" },
    ],
  }),
